...
namespace ExerciseTemplatePages.Features.ExercisePages
{
    /// <summary>
    ...
    [Guid("e668475f-66aa-497a-9fb0-9d4f286db54a")]
    public class ExercisePagesEventReceiver : SPFeatureReceiver
    {
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            //MAY CHANGE TO ROOTWEB and SCOPE this to Site Collection later on
            var web = properties.Feature.Parent as SPWeb;
            ApplyMasterPage(web, "exercise-seattle.master");
        ...
        public override void FeatureDeactivating(SPFeatureReceiverProperties properties)
        {
            ...
            PerformCleanupOnPropertyBag(web);
        }
