define(function (require) {
    ...
    function getAnnouncements_Current() {
        ...
        return $().SPServices({
            operation: "GetListItems",
            listName: 'Exercise Announcements',
            async: true,
            CAMLQuery: camlQuery,
    ...
    function getExerciseCalendar_Next24Hours() {
        var now = moment();
    ...
    function getExerciseCalendar_BattleRhythm(selectedDate) {
        var camlQuery =
            "<Query>\
        ...
        return $().SPServices({
            operation: "GetListItems",
            listName: 'Exercise Calendar',
            async: true,
            CAMLQuery: camlQuery,
            CAMLQueryOptions: camlQueryOptions,
            CAMLViewFields: schemas.exerciseCalendar.camlViewFields
        }).then(function (xData, status) {

            var json = $(xData).SPFilterNode("z:row").SPXmlToJson({
                mapping: schemas.exerciseCalendar.jsonMapping,
                includeAllAttrs: false
            });
